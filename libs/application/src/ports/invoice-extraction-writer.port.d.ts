...
export interface InvoiceExtractionWriterPort {
    mergeIaExtractedData(ctx: TenantOrgContext, invoiceId: string, patch: InvoiceIaExtractedPatch, write: SingleTableWriteContext): Promise<void>;
}
//# sourceMappingURL=invoice-extraction-writer.port.d.ts.map