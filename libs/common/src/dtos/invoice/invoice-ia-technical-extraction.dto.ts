...
export function parseInvoiceIaExtractionSqsBody(input: unknown): InvoiceIaExtractionSqsBody {
 ...
 */
export function buildInitialInvoiceIaTechnicalExtraction(
  params: Partial<Pick<InvoiceIaTechnicalExtraction, 'extractionJobId' | 'workerHostId'>> & {
