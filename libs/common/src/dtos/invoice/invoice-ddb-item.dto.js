...
export const parseInvoiceDdbItem = (input) => InvoiceDdbItemSchema.parse(input);
export const safeParseInvoiceDdbItem = (input) => InvoiceDdbItemSchema.safeParse(input);
export const parseInvoiceConfirmPayload = (input) => InvoiceConfirmPayloadSchema.parse(input);
export const safeParseInvoiceConfirmPayload = (input) => InvoiceConfirmPayloadSchema.safeParse(input);
//# sourceMappingURL=invoice-ddb-item.dto.js.map