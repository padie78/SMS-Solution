...
export const parseOrgConfigDTO = (input) => OrgConfigDTOSchema.parse(input);
export const safeParseOrgConfigDTO = (input) => OrgConfigDTOSchema.safeParse(input);
//# sourceMappingURL=org-config.dto.js.map