...
export class InvoiceEntity {
    ...
    processedAt;
    totalDaysProrated;
    constructor(pk, sk, aiAnalysis, analyticsDimensions, climatiqResult, extractedData, metadata, technicalExtraction, processedAt, totalDaysProrated) {
        this.pk = pk;
        this.sk = sk;
        this.aiAnalysis = aiAnalysis;
        this.analyticsDimensions = analyticsDimensions;
        this.climatiqResult = climatiqResult;
        this.extractedData = extractedData;
        this.metadata = metadata;
        this.technicalExtraction = technicalExtraction;
        this.processedAt = processedAt;
        this.totalDaysProrated = totalDaysProrated;
     ...
     */
    static fromDTO(dto) {
        return new InvoiceEntity(dto.pk, dto.sk, dto.aiAnalysis, dto.analyticsDimensions, dto.climatiqResult, dto.extractedData, dto.metadata, dto.technicalExtraction, dto.processedAt, dto.totalDaysProrated);
    }
    /**
     ...
     */
    getDailyAverageConsumption() {
        if (this.totalDaysProrated <= 0)
            return 0;
