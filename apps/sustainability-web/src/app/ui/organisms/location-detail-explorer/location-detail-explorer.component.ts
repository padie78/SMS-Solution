...
@Component({
  ...
  template: `
    <div class="h-full min-w-0">
      <div *ngIf="node as selected; else empty" class="mx-auto w-full max-w-[980px] space-y-6">
        <header class="w-full border-b border-slate-200/90 pb-5">
          ...
          <div class="mt-3 flex flex-wrap items-baseline gap-x-2 gap-y-1">
            ...
            <span class="break-all font-mono text-sm font-semibold text-slate-800">{{ selected.location_id }}</span>
          </div>
        </header>
